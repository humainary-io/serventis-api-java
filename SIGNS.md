...
independent of the *evaluative* `STATUS` reading — see `Serventis.Kind` and the "two ascent paths"
discussion ("The Kind of a Sign") in `SERVENTIS.md`.
...
**Total unique signs analyzed**: ~210+ across 33 APIs (including: Actors, Agents, Caches, Pipelines,
Leases, Gauges, Counters, Probes, Routers, Breakers, Statuses, Situations, Cycles)
