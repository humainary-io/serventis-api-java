...
public final class Situations
  ...
  /// var situations = circuit.conduit(Signal.class).lookup(Situations::of);
  ...
  /// Returns a lookup that creates cached Situation instruments from a conduit.
  ///
  /// Example usage:
  /// ```java
  /// Pool<Situation> situations = Situations.lookup(conduit);
  /// var situation = situations.get(name);
  /// ```
  ///
  /// @param conduit the conduit providing signal pipes
  /// @return a lookup that creates Situation instruments
