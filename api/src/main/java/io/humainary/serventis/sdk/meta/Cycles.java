...
/// var cycle   = Cycles.lookup(Resources.Sign.class, conduit).get(cortex.name("db.pool.cycles"));
///
...
public final class Cycles
  ...
  /// Returns a lookup that creates cached Cycle instruments from a conduit.
  ///
  /// @param <S>       the Sign enum type from the source API
  /// @param signClass the class object for the sign enum
  /// @param conduit   the conduit providing signal pipes
  /// @return a lookup that creates Cycle instruments
