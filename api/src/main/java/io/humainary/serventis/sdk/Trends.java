...
/// var trend   = Trends.pool(conduit).get(cortex.name("api.latency"));
///
...
public final class Trends
  ...
  /// Returns a pool that creates cached Trend instruments from a conduit.
  ///
  /// @param conduit the conduit providing sign pipes
  /// @return a pool that creates Trend instruments
