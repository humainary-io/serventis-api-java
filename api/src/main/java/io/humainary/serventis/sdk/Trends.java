...
/// var trend   = Trends.lookup(conduit).get(cortex.name("api.latency"));
///
...
public final class Trends
  ...
  /// Creates a Trend instrument wrapping the specified pipe.
  ///
  /// @param pipe the pipe from which to create the trend
  /// @return a new Trend instrument for the specified pipe
  ...
  /// Returns a lookup that creates cached Trend instruments from a conduit.
  ///
  /// @param conduit the conduit providing sign pipes
  /// @return a lookup that creates Trend instruments
  /// @throws NullPointerException if the conduit parameter is `null`

  @New
  @NotNull
  public static Pool < Trend > pool (
