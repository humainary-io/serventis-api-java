...
/// ## Purpose
///
/// This API offers the smallest possible outcome vocabulary for universal rollup
...
/// var outcome = Outcomes.lookup(conduit).get(cortex.name("payment.outcomes"));
///
/// // Emit verdicts
...
public final class Outcomes
  ...
  /// Returns a lookup that creates cached Outcome instruments from a conduit.
  ///
  /// @param conduit the conduit providing sign pipes
  /// @return a lookup that creates Outcome instruments
