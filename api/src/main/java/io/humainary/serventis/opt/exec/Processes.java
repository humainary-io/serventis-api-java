...
/// - RESTART pattern → DIVERGING status (supervision active)
/// - Frequent KILL → DEFECTIVE status (processes unresponsive)
/// - Crash loop (rapid RESTART) → DOWN status (failing to recover)
///
...
public final class Processes
  ...
  /// Returns a lookup that creates cached Process instruments from a conduit.
  ///
  /// @param conduit the conduit providing sign pipes
  /// @return a lookup that creates Process instruments
