...
/// var probe = circuit.conduit(Signal.class).lookup(Probes::of).get(cortex.name("rpc"));
///
...
public final class Probes
  ...
  /// Returns a lookup that creates cached Probe instruments from a conduit.
  ///
  /// @param conduit the conduit providing signal pipes
  /// @return a lookup that creates Probe instruments
