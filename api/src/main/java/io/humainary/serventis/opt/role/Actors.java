...
/// var human = circuit.conduit(Sign.class).lookup(Actors::of).get(cortex.name("user.william"));
/// var ai = circuit.conduit(Sign.class).lookup(Actors::of).get(cortex.name("assistant.claude"));
///
...
public final class Actors
  ...
  /// Returns a lookup that creates cached Actor instruments from a conduit.
  ///
  /// @param conduit the conduit providing sign pipes
  /// @return a lookup that creates Actor instruments
