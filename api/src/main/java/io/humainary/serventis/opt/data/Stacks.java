...
///   .lookup(Stacks::of).get(cortex.name("thread.callstack"));
///
/// // Method entry
...
///   .lookup(Stacks::of).get(cortex.name("editor.undo"));
/// var redoStack = circuit.conduit(Sign.class)
///   .lookup(Stacks::of).get(cortex.name("editor.redo"));
///
...
/// ```java
/// var stack = circuit.conduit(Sign.class)
///   .lookup(Stacks::of).get(cortex.name("parser.brackets"));
///
...
/// ```java
/// var stack = circuit.conduit(Sign.class)
///   .lookup(Stacks::of).get(cortex.name("calculator.operands"));
///
...
/// ```java
/// var stack = circuit.conduit(Sign.class)
///   .lookup(Stacks::of).get(cortex.name("worker.localqueue"));
///
...
/// ```java
/// var stack = circuit.conduit(Sign.class)
///   .lookup(Stacks::of).get(cortex.name("search.states"));
///
...
public final class Stacks
  ...
  /// Returns a lookup that creates cached Stack instruments from a conduit.
  ///
  /// @param conduit the conduit providing sign pipes
  /// @return a lookup that creates Stack instruments
