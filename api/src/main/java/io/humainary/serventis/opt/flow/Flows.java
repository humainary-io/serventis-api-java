...
///   .lookup(Flows::of).get(cortex.name("queue.orders"));
///
/// // Message received
...
/// ```java
/// var flow = circuit.conduit(Signal.class)
///   .lookup(Flows::of).get(cortex.name("pipeline.etl"));
///
...
/// ```java
/// var flow = circuit.conduit(Signal.class)
///   .lookup(Flows::of).get(cortex.name("http.requests"));
///
/// // Request received
...
public final class Flows
  ...
  /// Returns a lookup that creates cached Flow instruments from a conduit.
  ///
  /// @param conduit the conduit providing signal pipes
  /// @return a lookup that creates Flow instruments
