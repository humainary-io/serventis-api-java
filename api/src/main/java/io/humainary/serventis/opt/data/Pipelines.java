...
/// var pipeline = circuit.conduit(Sign.class).lookup(Pipelines::of).get(cortex.name("etl.customer.enrichment"));
///
/// // Data flow
/// pipeline.input();
/// pipeline.output();
...
public final class Pipelines
  ...
  /// Returns a lookup that creates cached Pipeline instruments from a conduit.
  ///
  /// @param conduit the conduit providing sign pipes
  /// @return a lookup that creates Pipeline instruments
