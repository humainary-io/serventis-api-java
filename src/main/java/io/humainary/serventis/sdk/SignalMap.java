...
/// reference; their mutability and thread safety remain the caller's responsibility. Mapping
/// functions run synchronously during construction, and a thrown failure aborts construction
/// and propagates to the caller rather than becoming an emission-time fault.
///
/// ## Contract scope
///
