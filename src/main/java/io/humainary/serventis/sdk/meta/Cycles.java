...
/// // Signal.class is a raw literal (no Signal<Resources.Sign>.class in Java), so the parameterized
...
public final class Cycles
  ...
  ///
  /// History lasts for the lifetime of each attachment: sightings do not expire and there is no
  /// rolling or timed window. A new attachment starts a new observation episode. The [Cycle]
  /// instrument instead reports classifications supplied by its caller.
  ///
  /// ```java
  /// cycles.pool ( Cycles.flow ( Resources.SIGNS ) );
  /// ```
  ...
  public enum Dimension
    ...
    /// episode. It represents a novel appearance of this particular sign value.
  ...
  /// ```
  ///
  /// @param <S> the Sign enum type from the source API being observed
