...
public final class Timers
  ...
  /// timer signal instances and caller-derived signal maps.
  ...
  ///
  /// @param sign      the time constraint outcome
  /// @param dimension the kind of time constraint being evaluated
