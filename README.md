...
| Document                                                                                   | Role                                                                                            |
|--------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| [SPEC.md](https://github.com/humainary-io/serventis-api-spec/blob/3.1.2/SPEC.md)           | Normative: the observation model, instruments, universal vocabularies, translation, conformance |
| [REGISTRY.md](https://github.com/humainary-io/serventis-api-spec/blob/3.1.2/REGISTRY.md)   | Normative membership: every registered vocabulary's signs and dimensions, fixed once published  |
| [RATIONALE.md](https://github.com/humainary-io/serventis-api-spec/blob/3.1.2/RATIONALE.md) | Non-normative: why the model is shaped as it is                                                 |

Serventis layers
over [Substrates](https://github.com/humainary-io/substrates-api-spec/blob/3.1.2/SPEC.md),
