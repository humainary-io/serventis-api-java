...
var conduit = circuit.conduit(Cycles.Signal.class);
var cycles = Cycles.pool(Resources.Sign.class, conduit);
...
var conduit = circuit.conduit(Surveys.Signal.class);
var surveys = Surveys.pool(Statuses.Sign.class, conduit);
...
- **Medium-frequency statuses**: 100K-1M Hz (condition assessment)
...
```bash
# Build all modules including serventis (from project root)
./build.sh

# Run all TCK tests including serventis (from project root)
./tck.sh

# Run a specific serventis test class (from testkit/private/)
cd testkit/private && ./mvnw test -Dtest=ActorsTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=AgentsTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=TransactionsTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=BreakersTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=CountersTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=GaugesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=CachesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=LeasesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=LocksTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=AtomicsTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=LatchesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=SystemsTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=StatusesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=PipelinesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=ProcessesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=RoutersTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=SensorsTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=TasksTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=TimersTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=CyclesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=ExchangesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=OutcomesTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=OperationsTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=TrendsTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=SurveysTest -pl serventis
cd testkit/private && ./mvnw test -Dtest=FlowsTest -pl serventis
```

### Running TCK Tests

Serventis TCK tests live under `testkit/private/serventis/` and validate integration with SPI
implementations:
...
# Or use build.sh with test flag
./build.sh -t
```

**Note**: Tests are skipped by default. Use `./tck.sh` or `./build.sh -t` from the project root to
enable testing. See `substrates/private/README.md` for more details on TCK configuration.
